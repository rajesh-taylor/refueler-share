...
1. **Share-Cred-Opus-1** (Opus, investigation only; small enough for pre-Berlin) — prompt in repo root `Share-Cred-Opus-1-prompt.md`. Verdict on the suspected credential-forgery flaw (scratch tests only, never probe prod), then NUT-11/NUT-12 design note → `docs/Cred-verification-note-v1.md`.
