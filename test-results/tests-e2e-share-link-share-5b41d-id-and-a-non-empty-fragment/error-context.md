...
- Name: tests/e2e/share-link.spec.js >> share URL contains ?uuid= and a non-empty fragment
- Location: tests/e2e/share-link.spec.js:36:5
...
Call log:
  ...
  - waiting for locator('#upload-btn')
    61 × locator resolved to <button disabled id="upload-btn" class="btn btn-primary btn-full">Encrypt & upload</button>
